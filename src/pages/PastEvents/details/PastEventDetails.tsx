    ...
    <>
      ...
      <div className="container mx-auto py-8 px-4 sm:px-8">
        ...
        {event.imageUrls?.length === 1 ? (
          <div
            className="col-span-2 relative h-72 sm:h-[600px] cursor-pointer overflow-hidden"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4 pt-5">
            <div
              className="col-span-2 relative h-64 sm:h-[400px] cursor-pointer"
              onClick={() => openGallery(0)}
            >
              <img
                src={event.imageUrls?.[0] ?? ""}
            ...
            <div className="grid grid-cols-2 gap-4">
              {event.imageUrls?.slice(1, 4).map((image, index) => (
                <div
                  key={index}
                  className="relative h-32 sm:h-48 cursor-pointer"
        ...
        <div className="mb-6">
          <h1 className="text-3xl text-blue-600 font-bold mt-5 mb-5">
            {event.title}
          </h1>
        ...
        {speakers.length > 0 && <EventSchedule schedule={eventShedule} />}
        ...
        <div className="bg-gray-800 p-6 rounded-lg text-gray-200 mt-8">
          ...
          <div className="overflow-x-auto">
            <p className="text-gray-500 text-left">
              ...
              as we have our seats are limited. Thank you for your cooperation.
            </p>
          </div>
        </div>
