...
import telegram from '@/static/members/kodj_telegram.jpg';
...
/**
 * QrCodeCard - A component to display QR code image.
 * The component uses framer-motion for animations and styled-components for styling.
 */
            ...
            <AnimatePresence>
                {isExpanded && (
                    <ExpandedOverlay
                        ...
                        exit={{ opacity: 0 }}
                    >
                        <ExpandedImageContainer initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.8 }}>
